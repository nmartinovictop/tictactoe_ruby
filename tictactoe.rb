...
class Game
  ...
  def game_won?
    if @board.board[0].all?('X') || @board.board[0].all?('O')
      ...
      true
    elsif [@board.board[0][0], @board.board[1][1],
           @board.board[2][2]].all?('X') || [@board.board[0][0], @board.board[1][1], @board.board[2][2]].all?('O')
      true
    elsif [@board.board[0][2], @board.board[1][1],
           @board.board[2][0]].all?('X') || [@board.board[0][2], @board.board[1][1], @board.board[2][0]].all?('O')
      true
    else
      false
    end
  ...
  def game_draw?
    return true if @board.board.flatten.none?(' ')
